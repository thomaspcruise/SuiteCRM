...
*}
<a href="index.php?entryPoint=download&id={$parentFieldArray.ID}&type=documents" class="tabDetailViewDFLink" target='_blank'>{sugar_fetch object=$parentFieldArray key=$col}
...
<a href="index.php?entryPoint=download&id={$parentFieldArray.ID}&type=documents" class="tabDetailViewDFLink" target='_blank' style="border-bottom: 0px;">
